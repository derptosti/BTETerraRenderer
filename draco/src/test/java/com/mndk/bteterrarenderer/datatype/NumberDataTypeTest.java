...
public class NumberDataTypeTest {
    ...
    public void givenTwoNumbers_whenDivide_thenCorrect() {
        // byte
        Assert.assertEquals((byte) 5, DataType.int8().div(Byte.valueOf((byte) 10), Byte.valueOf((byte) 2)).byteValue());
        Assert.assertEquals((byte) -3, DataType.int8().div(Byte.valueOf((byte) -6), Byte.valueOf((byte) 2)).byteValue());
        ...
        // short
        Assert.assertEquals((short) 5, DataType.int16().div(Short.valueOf((short) 10), Short.valueOf((short) 2)).shortValue());
        Assert.assertEquals((short) -3, DataType.int16().div(Short.valueOf((short) -6), Short.valueOf((short) 2)).shortValue());
        ...
        // int
        Assert.assertEquals(5, DataType.int32().div(Integer.valueOf(10), Integer.valueOf(2)).intValue());
        Assert.assertEquals(-3, DataType.int32().div(Integer.valueOf(-6), Integer.valueOf(2)).intValue());
        ...
        // long
        Assert.assertEquals(5L, DataType.int64().div(Long.valueOf(10L), Long.valueOf(2L)).longValue());
        Assert.assertEquals(-3L, DataType.int64().div(Long.valueOf(-6L), Long.valueOf(2L)).longValue());
